...
// class MapUtil{
//
//   final directions = APIDirections.GoogleMapsDirections(apiKey: 'AIzaSyB4NvO-1XnyEyRG9p-eUP8_tLIDLeApFws');
//   final geolocation = APIGeolocation.GoogleMapsGeolocation(apiKey: 'AIzaSyB4NvO-1XnyEyRG9p-eUP8_tLIDLeApFws');
//
